...
- Updated Streamlink to 8.3.0, updated its dependencies
- Updated Python from 3.14.3 to 3.14.4
- Updated FFmpeg to n8.1-5-g3ec48e4bc6, with latest library versions

## 8.2.1-1 (2026-03-05)

- Updated Streamlink to 8.2.1, updated its dependencies

## 8.2.0-1 (2026-02-09)

- Updated Streamlink to 8.2.0
- Updated Python from 3.14.2 to 3.14.3

## 8.1.2-1 (2026-01-18)

- Updated Streamlink to 8.1.2

## 8.1.1-1 (2026-01-17)

- Updated Streamlink to 8.1.1, updated its dependencies

## 8.1.0-2 (2025-12-14)

- Updated Streamlink to 8.1.0, updated its dependencies
- Updated Python from 3.14.0 to 3.14.2
- Fixed build name referencing old Python version
...
- Updated Python from 3.13.4 to 3.13.5

## 7.4.0-1 (2025-06-08)

- Updated Streamlink to 7.4.0, updated its dependencies
- Updated Python from 3.13.3 to 3.13.4

## 7.3.0-1 (2025-04-26)

- Updated Streamlink to 7.3.0, updated its dependencies
- Updated Python from 3.13.2 to 3.13.3
